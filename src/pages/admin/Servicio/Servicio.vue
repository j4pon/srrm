<template>
  ...
  import Listado from "./Servicio.listado.vue";
  import Nuevo from "./Servicio.nuevo.vue";
  
  
  const TABS = [
    { icon: "feed", title: "Listado Servicio", co:"T", component: Listado },
    { icon: "feed", title: "Agregar Servicio", co:"N", component: Nuevo },
  ];
