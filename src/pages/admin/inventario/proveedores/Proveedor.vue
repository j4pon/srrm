<template>
  ...
  import Listado from "./Proveedor.listado.vue";
  import Nuevo from "./Proveedor.nuevo.vue";
  
  
  const TABS = [
    { icon: "feed", title: "Listado Proveedor", co:"T",component: Listado },
    { icon: "feed", title: "Agregar Proveedor", co:"N",component: Nuevo },
  ];
