<template>
  ...
  import Listado from "./Vehiculo.listado.vue";
  import Nuevo from "./Vehiculo.nuevo.vue";
  
  
  const TABS = [
    { icon: "feed", title: "Listado Vehiculos", co:"T", component: Listado },
    { icon: "feed", title: "Agregar Vehiculo", co:"N", component: Nuevo },
  ];
